...
driver.get('https://www.domain.com.au/rent/?postcode=3006&excludedeposittaken=1&page=1')
...
for page in range(1,pages_to_search+1):
    driver.get('https://www.domain.com.au/rent/?postcode=3006&excludedeposittaken=1&page=' + str(page))
